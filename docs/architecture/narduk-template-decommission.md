...
| ------------------------- | ---------------------------------------------- | ----------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ | ----------------- |
| been-sober-for            | `narduk-enterprises/been-sober-for`            | Reference; analytics, auth, SEO, uploads        | Source production exact SHA `e949bd9873bd72d60efcff870e50b863353d3983`; Worker version `5210061e-998f-467e-98b0-2c57229c6783`; deployment `af7b74fe-48a3-4d1f-8e3f-995b090486f0`; [evidence PR #64](https://github.com/narduk-enterprises/been-sober-for/pull/64), merge `62636a5f7654caf902706e33f689776b5bc005ba`; Cloudflare source `d715…8fdd`, target `73a8…d265` | [Decoupling PR #62](https://github.com/narduk-enterprises/been-sober-for/pull/62), merge `e949bd9873bd72d60efcff870e50b863353d3983`; frozen lock installs exact immutable `@narduk-enterprises/*` versions from GitHub Packages | Exact-head app-owned CI passed; disposable target rehearsal at `e949bd9` reconciled schema, indexes, counts, 21 legacy plus 8 stable D1 journal entries, and an empty rerun; target KV remained empty; R2 reconciled 14 objects and 5,818,346 bytes | Source production serves exact SHA and passed health/public/auth route proof; disposable target `workers.dev` rehearsal served exact SHA in read-only mode and returned `503` plus `Retry-After` for protected mutations; target production D1, Workers Build, DNS, Custom Domains, certificates, and Registrar transfer remain pending | PR #62 exact-head forbidden-reference gate passed; repeat final fleet scan after account cutover | production-proved |
