...
Cross-account Cloudflare and domain moves follow the canonical
[Cloudflare account and domain cutover runbook](../operations/cloudflare-account-cutover.md).
Each application keeps its filled execution record in its own repository while
this ledger retains the durable PR, deployment, migration, route, and
zero-reference proof links.
...
| ------------------------- | ---------------------------------------------- | ----------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- |
| been-sober-for            | `narduk-enterprises/been-sober-for`            | Reference; analytics, auth, SEO, uploads        | Source production exact SHA `e949bd9873bd72d60efcff870e50b863353d3983`; Worker version `5210061e-998f-467e-98b0-2c57229c6783`; deployment `af7b74fe-48a3-4d1f-8e3f-995b090486f0`; [evidence PR #64](https://github.com/narduk-enterprises/been-sober-for/pull/64), merge `62636a5f7654caf902706e33f689776b5bc005ba`; Cloudflare source `d715…8fdd`, target `73a8…d265` | [Decoupling PR #62](https://github.com/narduk-enterprises/been-sober-for/pull/62), merge `e949bd9873bd72d60efcff870e50b863353d3983`; frozen lock installs exact immutable `@narduk-enterprises/*` versions from GitHub Packages; final infrastructure record in [PR #70](https://github.com/narduk-enterprises/been-sober-for/pull/70), head `19ad68e1f602d3c1c511fc5577284779c6e13fe1` | Exact-head app-owned CI passed; disposable target rehearsal at `e949bd9` reconciled schema, indexes, counts, 21 legacy plus 8 stable D1 journal entries, and an empty rerun; final production import again reconciled 12-table schema, 21 legacy plus 8 stable rows, counts, and an empty rerun; KV remained empty; R2 matched at 14 objects and 5,818,346 bytes | Infrastructure account cutover completed 2026-07-15: target commit `06ba0dc339d28088b9e1f032e65dbb5337b4502d`, version `5a78ec42-5ee1-430a-82e8-9ec2b5af9dac` at 100%, permanent Workers Build trigger `7db4ce7c-ca5f-4dab-a398-24665c87c75d`, active target zone, accepted Registrar transfer, apex and `www` Custom Domains with valid HTTPS, public-route proof, and writes reopened after `25m58s`; physical authentication is operator-attested, but physical profile mutation and upload/retrieval remain unproven | PR #62 exact-head forbidden-reference gate and PR #70 old-account/cutover-reference gate passed; final program-wide fleet scan remains pending | production-proved — infrastructure cutover complete; physical profile/upload and 30-day retention pending |
...
The package and source-account portion is proven. Been Sober For
[PR #62](https://github.com/narduk-enterprises/been-sober-for/pull/62) merged at
`e949bd9873bd72d60efcff870e50b863353d3983`, installs exact immutable packages
from GitHub Packages, and passed its exact-head app-owned CI. That commit is
also proven in source production; the durable source evidence is
[PR #64](https://github.com/narduk-enterprises/been-sober-for/pull/64), merged
at `62636a5f7654caf902706e33f689776b5bc005ba`.

The target-account disposable rehearsal is also green at the exact application
SHA. D1 reconciled schema, indexes, all relevant table counts, 21 legacy ledger
entries, and 8 stable journal entries; its second migration run was empty. KV
remained empty. R2 reconciled 14 objects totaling 5,818,346 bytes. Public reads
remained available in read-only maintenance mode while protected mutations
returned `503` with `Retry-After`.

This is not the account/domain cutover. The target production D1, Workers Build,
zone and DNS reproduction, Registrar move, Custom Domains, certificates,
write-enabled route proof, physical-iPhone proof, and 30-day retention closeout
