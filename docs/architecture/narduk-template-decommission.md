...
| ------------------------- | ---------------------------------------------- | ----------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------- | -------------------------------------- | --------------- |
| been-sober-for            | `narduk-enterprises/been-sober-for`            | Reference; analytics, auth, SEO, uploads        | `b22a660`; `www.beensoberfor.com` 200; `/api/health` 200; auth runtime 200; D1 recovery bookmark captured 2026-07-14; Cloudflare source `d715…8fdd`, target `73a8…d265` | Local cutover `0574482`; immutable publication and PR pending; account/domain execution record in progress | Local quality, browser, build, D1 apply plus empty rerun, and packed-artifact proof green; target production-copy rehearsal pending | Current deployed SHA `b22a660f0a64`; target Worker/domain proof pending | Local proof green; remote scan pending | local-validated |
