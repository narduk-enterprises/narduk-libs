...
```sh
pnpm dlx @narduk-enterprises/create-narduk-app@0.1.4 harbor-notes \
...
a non-secret `.npmrc` that reads `GH_PACKAGES_READ` from the process environment,
and routes both `@narduk-enterprises/*` and `@narduk-geo/*`
