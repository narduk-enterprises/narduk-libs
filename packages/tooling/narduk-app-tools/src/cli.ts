...
function usage(): string {
  return [
    ...
    '                                       for recovery). Exit 3 version not found, 4 ambiguous,',
    '                                       5 wrangler failed.',
