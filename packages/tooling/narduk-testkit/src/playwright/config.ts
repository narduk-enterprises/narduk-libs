...
export function specMatchesProject(filePath: string, projectName: string): boolean {
...
export function collectSpecsForProject(
  ...
  return filePaths.filter((filePath) => specMatchesProject(filePath, projectName))
}
