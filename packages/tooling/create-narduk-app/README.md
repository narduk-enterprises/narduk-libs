...
```sh
pnpm dlx @narduk-enterprises/create-narduk-app@0.1.15 harbor-notes \
...
environment, and routes `@narduk-enterprises/*` to GitHub Packages. The
onboarding skill owns the first authenticated install and commits the resulting
frozen lockfile before CI is enabled.
