...
export const PACKAGE_VERSIONS = {
  ...
  '@narduk-enterprises/narduk-app-tools': '0.22.2',
  '@narduk-enterprises/eslint-config': '2.4.0',
  '@narduk-enterprises/narduk-ai': '0.3.24',
  '@narduk-enterprises/narduk-analytics': '1.25.1',
  '@narduk-enterprises/narduk-auth': '1.30.1',
  '@narduk-enterprises/narduk-charts': '2.7.1',
