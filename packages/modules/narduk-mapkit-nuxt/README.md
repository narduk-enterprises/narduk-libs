...
| `calloutFocus`           | `'keyboard'` | Move focus into the callout after a keyboard pin selection. `'never'` opts out. A pointer selection always leaves focus where it is (narduk-libs#746).                                                                                                   |
