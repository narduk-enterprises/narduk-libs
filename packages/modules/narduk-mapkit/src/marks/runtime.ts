 ...
 */
export function asMkRuntime(value: unknown): MkRuntime | null {
...
export function asMkMap(value: unknown): MkMap | null {
  if (typeof value !== 'object' || value === null) return null
  return 'visibleMapRect' in value && 'addAnnotations' in value ? (value as MkMap) : null
}
