...
export type FakeMapKitOperationName = 'Annotation' | 'ImageAnnotation' | 'Map' | 'Map.destroy' | 'MarkerAnnotation' | 'addAnnotation' | 'addAnnotations' | 'annotations=' | 'authorizationCallback' | 'bootstrap' | 'callout-remove' | 'callout-render' | 'configuration-change' | 'deselect' | 'error' | 'init' | 'load' | 'region=' | 'removeAnnotation' | 'removeAnnotations' | 'select' | 'selectedAnnotation=' | 'setCenterAnimated' | 'setRegionAnimated' | 'showItems';
