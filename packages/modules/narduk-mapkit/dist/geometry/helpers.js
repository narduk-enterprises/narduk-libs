 ...
 */
export function clampLongitude(lng) {
 ...
 */
export function computeCoordinateBounds(points, padding = 0.05, minSpanDelta = 0.01) {
...
export function haversineDistanceMetres(a, b) {
    ...
    const aCos = sinDLat * sinDLat + Math.cos(toRad(a.lat)) * Math.cos(toRad(b.lat)) * sinDLng * sinDLng;
 ...
 */
export function gridCluster(items, gridSizeDegrees = 0.5) {
