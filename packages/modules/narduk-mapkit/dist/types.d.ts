...
export type MapKitMarkerElementFactory<TMarker extends MapKitMarkerDrawable = MapKitMarkerDrawable> = (marker: TMarker, isSelected: boolean) => MapKitMarkerElementResult;
export type MapKitClusterElementFactory = (cluster: {
    coordinate: unknown;
...
export type MapKitGeoJSONGeometryV2 = MapKitGeoJSONPointGeometryV2 | MapKitGeoJSONLineStringGeometryV2 | MapKitGeoJSONMultiLineStringGeometryV2 | MapKitGeoJSONPolygonGeometryV2 | MapKitGeoJSONMultiPolygonGeometryV2;
export interface MapKitGeoJSONFeatureV2<TProperties extends MapKitGeoJSONFeaturePropertiesV2 = MapKitGeoJSONFeaturePropertiesV2> {
    geometry: MapKitGeoJSONGeometryV2;
    id?: string | number;
    properties: TProperties;
    type: 'Feature';
}
export interface MapKitGeoJSONFeatureCollectionV2<TProperties extends MapKitGeoJSONFeaturePropertiesV2 = MapKitGeoJSONFeaturePropertiesV2> {
    features: ReadonlyArray<MapKitGeoJSONFeatureV2<TProperties>>;
    type: 'FeatureCollection';
}
export type MapKitDrawableV2 = MapKitMarkerDrawableV2 | MapKitLineDrawableV2 | MapKitPolygonDrawableV2 | MapKitCircleDrawableV2 | MapKitGeoJSONFeatureDrawableV2;
