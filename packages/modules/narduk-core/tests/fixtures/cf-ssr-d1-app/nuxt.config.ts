/**
 * Minimal D1 app for `scripts/prove-cf-ssr-d1.mjs` (narduk-libs#49): pages
 * whose SSR `useFetch` and global `$fetch` reach a D1-backed route through Nitro's internal
