 ...
 */
export declare const NARDUK_ROUTER_HEADER_PREFIX = "x-narduk-";
/** Header the router sets when an authoriser returns one under this name. */
export declare const PRINCIPAL_HEADER = "x-narduk-principal";
 ...
 * ```
 */
export declare function principalFromRequest<Principal = unknown>(request: PrincipalCarrier, header?: string): Principal | undefined;
