 ...
 */
export function installRealtimeWorkerEntry(options: RealtimeInstallOptions): RealtimeInstallation {
  ...
  if (durableObjects.length === 0 && upgrades.length === 0) return { durableObjects, upgrades }
